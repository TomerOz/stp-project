...
RESPONSE_LABELS = {RIGHT : EVEN, LEFT: ODD} 
...
## BLOCKS --> should be flexible to be controlled from the outside, and 
## TRIALS --> trials sould be controled from the outside, and be repondent to blocks ammount (1 block = all trials in 1 block, 
# otherwise, ammount of trials is the ammount of sentences (repettion) got from the console devided by the ammount of blocks)
