...
'''
Tomer adapt this class to create as many much splits of sentence groups (dependeig on unique sentences tasks requirements)
annd --> duplicate sentences before radomization to as many much repetition set.
'''
