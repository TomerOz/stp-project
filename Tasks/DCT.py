...
class DctTask(object):
    ...
    def __init__(self, gui, exp, td, flow, response_labels=None, inter_trial_interval=None):
        self.gui = gui
        self.exp = exp
        self.td = td
        self.flow = flow
        ...
        if response_labels == None:
            ...
            self.response_labels = response_labels
            self.td.response_labels = response_labels
        if inter_trial_interval == None:
            self.inter_trial_interval = DCT_INTER_TRIAL_INTERVAL
        else:
    ...
    def _continue(self):
        ...
        if self.td.current_trial_type_intance.is_change_block_trial:
            ...
            self.gui.after(self.inter_trial_interval, self._trial)
